...
async function runSelfTest() {
  ...
  const tests = [
    ...
    testCase('missing IAM-005 authority validation', COMMAND_CATALOG, (s) => s.replaceAll('iam005:validate', 'iam005:removed'), 'missing required command token iam005:validate'),
