export const CI_SUITE_SEGMENTS = Object.freeze({
  quality: Object.freeze({
    policy: Object.freeze([
      ...
      command('ui-validate', 'Validate canonical design-token policy and generated CSS parity', 'pnpm', ['ui:validate']),
      command('ui-self-test', 'Run design-token policy negative tests', 'pnpm', ['ui:self-test']),
