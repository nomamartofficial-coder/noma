export const CI_SUITE_SEGMENTS = Object.freeze({
  quality: Object.freeze({
    policy: Object.freeze([
      ...
      command('ui-validate', 'Validate design-token, primitive, accessibility, and generated CSS policy', 'pnpm', ['ui:validate']),
      command('ui-self-test', 'Run UI token and primitive policy negative tests', 'pnpm', ['ui:self-test']),
