export const CI_SUITE_SEGMENTS = Object.freeze({
  quality: Object.freeze({
    policy: Object.freeze([
      ...
      command('iam007-validate', 'Validate IAM-007 closed disclosure and minimum query boundaries', 'pnpm', ['iam007:validate']),
      command('iam007-self-test', 'Run IAM-007 privacy boundary negative fixtures', 'pnpm', ['iam007:self-test']),
      command('iam008-validate', 'Validate IAM-008 append-only audit, authority, privacy, and non-activation boundaries', 'pnpm', ['iam008:validate']),
      command('iam008-self-test', 'Run IAM-008 audit boundary negative fixtures', 'pnpm', ['iam008:self-test']),
      ...
      command('traceability-iam008', 'Resolve IAM-008 traceability', 'python', ['scripts/validate_traceability.py', '--lookup', 'IAM-008']),
    ...
    tests: Object.freeze([
      ...
      command('iam007-unit', 'Run IAM-007 disclosure, query-shape, masking, and IDOR unit tests', 'pnpm', ['iam007:test']),
      command('iam008-unit', 'Run IAM-008 registry, disclosure, recursion, sentinel, and viewer tests', 'pnpm', ['iam008:test']),
  ...
  integration: Object.freeze({
    ...
    database: Object.freeze([
      ...
      command('iam007-integration', 'Run IAM-007 PostgreSQL minimum Access read-model verification', 'pnpm', ['iam007:integration-test']),
      command('iam008-integration', 'Run IAM-008 PostgreSQL append-only, transaction, idempotency, and IAM mutation verification', 'pnpm', ['iam008:integration-test']),
  ...
  security: Object.freeze({
    repository: Object.freeze([
      ...
      command('iam007-validate', 'Validate IAM-007 disclosure and query-minimization boundary', 'pnpm', ['iam007:validate']),
      command('iam007-self-test', 'Prove IAM-007 privacy regressions are rejected', 'pnpm', ['iam007:self-test']),
      command('iam008-validate', 'Validate IAM-008 audit authority and tamper boundaries', 'pnpm', ['iam008:validate']),
      command('iam008-self-test', 'Prove IAM-008 audit boundary regressions are rejected', 'pnpm', ['iam008:self-test']),
      command('iam008-security-coverage', 'Run IAM-008 authority, IDOR, sentinel, tamper, and recursion tests', 'pnpm', ['iam008:test']),
  ...
  windows: Object.freeze({
    compatibility: Object.freeze([
      ...
      command('iam007-validate', 'Validate IAM-007 privacy boundary on Windows', 'pnpm', ['iam007:validate']),
      command('iam007-self-test', 'Run IAM-007 privacy negative fixtures on Windows', 'pnpm', ['iam007:self-test']),
      command('iam007-unit', 'Run IAM-007 disclosure and query-shape unit tests on Windows', 'pnpm', ['iam007:test']),
      command('iam008-validate', 'Validate IAM-008 audit boundaries on Windows', 'pnpm', ['iam008:validate']),
      command('iam008-self-test', 'Run IAM-008 audit negative fixtures on Windows', 'pnpm', ['iam008:self-test']),
      command('iam008-unit', 'Run IAM-008 registry, disclosure, and viewer tests on Windows', 'pnpm', ['iam008:test']),
