...
export function validateAuthenticationSources(sources) {
  ...
  for (const expected of [
    ...
    'IAM-003,EP03,Implement email verification and password recovery,P0,P0-AUTHORITY,COMPLETE',
  ]) {
...
function selfTest(original) {
  const fixtures = [
    ...
    ['regressed IAM-003', 'taskIndex', 'IAM-003,EP03,Implement email verification and password recovery,P0,P0-AUTHORITY,COMPLETE', 'IAM-003,EP03,Implement email verification and password recovery,P0,P0-AUTHORITY,NOT_STARTED'],
  ];
