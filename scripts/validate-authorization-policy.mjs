...
function validate(source) {
  ...
  require(source.taskIndex.includes('IAM-007,EP03,Implement field-level projections and sensitive-data redaction,P0,P0-PRIVACY,NOT_STARTED'), 'IAM007_DEFERRED');
...
if (process.argv.includes('--self-test')) {
  const fixtures = [
    ...
    ['premature IAM-007', { taskIndex: current.taskIndex.replace('IAM-007,EP03,Implement field-level projections and sensitive-data redaction,P0,P0-PRIVACY,NOT_STARTED', 'IAM-007,EP03,Implement field-level projections and sensitive-data redaction,P0,P0-PRIVACY,IN_REVIEW') }],
