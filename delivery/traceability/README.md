...
The baseline contains all **152** backlog tasks, including all **141 P0 tasks**. Each task has one canonical acceptance requirement, one planned verification obligation, and one planned evidence obligation.
...
- `task-index.csv` — plain-text summary of all 152 tasks.
- `requirement-index-01.csv` through `requirement-index-03.csv` — plain-text summaries of all 152 acceptance requirements.
