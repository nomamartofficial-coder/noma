...
The baseline contains all **153** backlog tasks, including all **142 P0 tasks**. Each task has one canonical acceptance requirement, one planned verification obligation, and one planned evidence obligation.
...
- `task-index.csv` — plain-text summary of all 153 tasks.
- `requirement-index-01.csv` through `requirement-index-03.csv` — plain-text summaries of all 153 acceptance requirements.
...
python scripts/validate_traceability.py --lookup SEC-006
