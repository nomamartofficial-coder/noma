...
| [`ACCESS.md`](ACCESS.md) | IAM-005 exact-scope Access authority facts and persistence |
| [`AUTHORIZATION.md`](AUTHORIZATION.md) | IAM-006 deny-by-default central policy, fact, PEP, and PDP boundaries |
...
pnpm ui:test
pnpm ui:verify
pnpm ui:shells:validate
pnpm ui:shells:self-test
pnpm ui:shells:test
